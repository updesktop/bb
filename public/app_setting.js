function fm_setting(){
  ...
  '<div  data-mode='+jmode+' data-opt=0 style="height:100%;width:100%;font-family:Arial Narrow,Arial,sans-serif;font-size:12px;padding:10px;border:0px solid lightgray;background:white;">'+
    ...
    '<div style="width:100%;height:'+pa_height+'px;padding:10px;border:1px solid lightgray;">'+      
      ...
      '<div style="width:100%;height:40px;padding:5px;margin-top:10px;text-align:center;border-radius:8px;border:1px solid lightgray;">'+      
        'Current DTR Month: <input id="inp_curdate" type="month" onchange="disp_setting(this.value);toggle_setting(false);mnu_edit_setting();" style="width:150px;height:100%;" value=""/>'+
      '</div>'+
